	...
	return (
		<>
			<CardContainer >
				...
				<CardBody>
                    <Link to="staff/doctors" className="hover:no-underline hover:bg-slate-100" >
                        <SmallCardDetail figure={201} detailTitle="Doctors" icon={faUserDoctor} />
					</Link>

                    <Link to="staff/nurses" className="hover:no-underline hover:bg-slate-100" >
                        <SmallCardDetail figure={256} detailTitle="Nurses" icon={faUserNurse} />
					</Link>

                    <Link to="staff/admins" className="hover:no-underline hover:bg-slate-100" >
