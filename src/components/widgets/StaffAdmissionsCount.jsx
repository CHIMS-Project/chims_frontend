...
export const StaffAdmissionsCount = () => {
	...
	const fetchTotal = useCallback(() => {
		...
		axios
			.get(`${BACKEND_API_URL}admissions/staff/${id}/count/`, {
				headers: {
	...
	return (
		<CardContainer className="bg-gradient-to-br from-blue-900 to-blue-500 flex-1">
			<div className="flex items-center justify-between">
				<div className="flex flex-col">
					<span className="text-white text-sm">Your Admissions</span>
